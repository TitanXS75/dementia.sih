...
export default function ManifestoSection() {
  return (
    <section id="manifesto" className="w-full bg-[#1E4334] text-[#F7F5F0] py-20 sm:py-28 overflow-hidden border-b border-white/10 relative">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-6 flex flex-col items-start text-left">
            ...
            <p className="font-serif text-xl sm:text-2xl text-[#C8F028] italic font-medium leading-snug mb-4">
            ...
            <div className="mt-8 pt-8 border-t border-white/15 w-full flex items-center gap-3">
              <span className="w-2 h-2 rounded-full bg-[#C8F028] shrink-0" />
          ...
          <div className="lg:col-span-6 flex flex-col justify-center text-left space-y-6 text-white/80 text-base sm:text-lg leading-relaxed">
            ...
            <ul className="space-y-3 pl-2">
              <li className="flex items-start gap-3">
                <span className="text-[#C8F028] font-bold">—</span>
            ...
            <div className="p-6 rounded-3xl bg-white/5 border border-white/10 space-y-3">
              ...
              <p className="text-sm text-[#C8F028] font-bold pt-2">
