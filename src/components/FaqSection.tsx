...
export default function FaqSection() {
  ...
  return (
    <section id="faqs" className="w-full bg-[#F7F5F0] py-20 sm:py-28 overflow-hidden border-b border-[#1A1814]/10">
              ...
              <div key={idx} className="py-6 sm:py-8 text-left">
                ...
                >
                  <div className="flex items-start gap-6 sm:gap-8">
                    <span className="font-serif font-light text-2xl sm:text-3xl text-[#1E4334]">
                      {faq.num}
                    </span>
                  ...
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 border border-[#1A1814]/15 transition-all ${
