      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 text-center">
        ...
        <div className="max-w-[1240px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-4 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col gap-5 text-left">
            ...
            <div className="rounded-[24px] p-6 bg-white border border-[#1E4334]/15 shadow-sm hover:border-[#1E4334]/35 hover:shadow-md transition-all duration-300 relative group">
              ...
              <button
                ...
                className="w-full py-2.5 rounded-xl bg-[#F7F5F0] hover:bg-[#1E4334] text-[#1E4334] hover:text-white font-semibold text-xs transition-all border border-[#1E4334]/20 flex items-center justify-center gap-2 active:scale-95"
              >
          ...
          <div className="lg:col-span-6 text-left">
            <div className="rounded-[32px] p-7 sm:p-9 bg-[#1E4334] text-[#F7F5F0] border-2 border-[#1E4334] shadow-2xl relative group overflow-hidden">
              ...
              {/* Subtle Ambient Glow */}
              <div className="absolute top-0 right-0 w-64 h-64 bg-[#C8F028]/10 rounded-full blur-3xl pointer-events-none" />
              ...
              <div className="relative z-10">
                ...
                <div className="rounded-2xl bg-[#143226] border border-white/15 p-4 mb-6 space-y-3">
                  {/* Tablet Status Bar */}
                ...
                <button
                  ...
                  className="w-full py-3.5 rounded-full bg-[#C8F028] hover:bg-white text-[#1A1814] font-semibold text-sm transition-all shadow-md flex items-center justify-center gap-2 active:scale-95 cursor-pointer"
                >
